...
pylab.title('Trasformata della modulazione dell\'ampiezza')
pylab.minorticks_on()
plt.show()
'''
...
pylab.title('Spettro di potenza della trasformata della modulazione della ampiezza')
pylab.minorticks_on()
plt.show()
'''
...
pylab.xlabel('f [Hz]')
pylab.ylabel('A [a.u.]')
pylab.title('Trasformata  della modulazione dell\'ampiezza in semilog(y)')
pylab.minorticks_on()
plt.show()
'''
...
pylab.xlabel('f [Hz]')
pylab.ylabel('A [a.u.]')
pylab.title('Spettro di potenza della trasformata della modulazione della ampiezza in semilog(y)')
pylab.minorticks_on()
plt.show()
'''