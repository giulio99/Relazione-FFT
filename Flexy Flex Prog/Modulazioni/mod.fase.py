...
plt.errorbar(T1,V2, linestyle='',marker='.',color='black')
plt.xlabel('t [s]')
plt.ylabel('V [a.u.]')
plt.show()
...
pylab.title('Trasformata della modulazione della fase')
pylab.minorticks_on()
plt.show()
...
pylab.title('Spettro di potenza della trasformata della modulazione della fase')
pylab.minorticks_on()
plt.show()
...
pylab.xlabel('f [Hz]')
pylab.ylabel('A [a.u.]')
pylab.title('Ampiezza della trasformata  della modulazione della fase in semilog(y)')
pylab.minorticks_on()
plt.show()
...
pylab.xlabel('f [Hz]')
pylab.ylabel('A [a.u.]')
pylab.title('Spettro di potenza della trasformata della modulazione della fase in semilog(y)')
pylab.minorticks_on()
plt.show()
